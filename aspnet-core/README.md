...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p b85866e0-f80f-490c-8728-ac13c6491f83
```

> `b85866e0-f80f-490c-8728-ac13c6491f83` is the password of the certificate, you can change it to any password you want.
